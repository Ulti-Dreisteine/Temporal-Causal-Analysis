...
if __name__ == "__main__":
    ...
    plt.hist(stat_bootstrap, bins=50, range=range_, alpha=0.7, label="MI bootstrap", color="red", density=True)
    ...
    # 画图
    plt.figure(figsize=(5, 3))
    plt.hist(stat_bootstrap, bins=50, alpha=0.7, label="MI bootstrap", color="red", density=True)
