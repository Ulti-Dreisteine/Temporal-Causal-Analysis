...
if __name__ == "__main__":
    ...
    X_samples = np.load("runtime/1阶投掷_X_samples.npy")[0, :1000]
    ...
    plt.suptitle("1阶投掷样本的马尔可夫链阶数检验", fontsize=14)
    plt.tight_layout()
    plt.savefig("fig/1阶投掷样本的马尔可夫链阶数检验.png", dpi=600, bbox_inches="tight")
    plt.show()
